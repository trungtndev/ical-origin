...
class AttentionRefinementModuleEncoder(nn.Module):
    def __init__(self, nhead: int, dc: int, cross_coverage: bool, self_coverage: bool):
        super(AttentionRefinementModuleEncoder, self).__init__()
    ...
    def forward(
        self, prev_attn: Tensor, key_padding_mask: Tensor, curr_attn: Tensor
    ) -> Tensor:
        """
        Parameters
        ----------
